...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            <img src="{{asset('/storage/image/logo1.jpg')}}" style="width:130px; height:80px;">
            <center>
       <h1 style="font-size: 40px; font-color:rgb(48, 42, 165)"><b>Blood Donation Management System</b></h1></center>
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="{{asset('/storage/image/img04.jpg')}}" style="width:100%; height:500px;">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('/storage/image/img01.jpg')}}" style="width:100%; height:500px;">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('/storage/image/img03.jpg')}}" style="width:100%; height:500px;">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('/storage/image/img.jpg')}}"style="width:100%; height:500px;">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('/storage/image/img02.jpg')}}"style="width:100%; height:500px;">
                  </div>
                </div>
